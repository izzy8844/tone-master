    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-[#18181b] rounded-2xl border border-zinc-700 p-6 text-center space-y-4">
        ...
        <p className="text-sm text-zinc-400">
          Registration is not configured. Set <code className="text-zinc-300 bg-zinc-800 px-1 rounded">NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY</code> in your environment variables to enable registration.
        </p>
        <Link
          href="/"
...
export default function SignUpPage() {
  if (!isClerkConfigured) return <FallbackSignUpPage />;
